...
import { selectIsInitialized, selectIsLoggedIn, selectStatus } from "./app.selector"
...
function App({ demo = false }: PropsType) {
  ...
  // const _isLoggedIn = useSelector<AppRootStateType, boolean>((state) => state.auth.isLoggedIn)
